...
// password:  aJhJSvL3WbYCCeo8
// mongodb+srv://hamitmizrak:aJhJSvL3WbYCCeo8@offlinenodejscluster.l3itd.mongodb.net/?retryWrites=true&w=majority&appName=OfflineNodejsCluster
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Router (Rotalar)
const dailyRoutes = require("./routes/daily_api_routes");
const { request } = require("http");

// http://localhost:1111/daily
...
const limiter = rateLimit({
  ...
  max: 2000, // buy süre zarfında en fazla bu kadar isterk atabilirsiniz.
...
app.get("/", csrfProtection, (request, response) => {
  ...
  app.post("/", csrfProtection, (request, response) => {
    ...
    if (!dailyData.header || !dailyData.content) {
    ...
    const newBlog = new BlogModel(dailyData);
    newBlog
      .save()
      .then(() => {
        console.log("Blog başarıyla kaydedildi:", dailyData);
        logger.info("Blog başarıyla kaydedildi:", dailyData); //logger: Winston
